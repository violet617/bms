 ...
 * @Description 基础数据类型--凭证类型
 */
public class TB_MD_BMS_VOR_TYPE {
    private static final String Base_Data_NAME = "MD_BMS_VOR_TYPE";

    private static final String Base_Data_TITLE = "凭证类型";
