 ...
 * @Description 基础数据类型--凭证周期
 */
public class TB_MD_BMS_VOR_CYCLE {
    private static final String Base_Data_NAME = "MD_BMS_VOR_CYCLE";

    private static final String Base_Data_TITLE = "凭证周期";
