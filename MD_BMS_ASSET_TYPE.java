 ...
 */
@Component
public class MD_BMS_ASSET_TYPE implements StorageSyncTask {
    @Override
    public void execute() {
        System.out.println("MD_BMS_ASSET_TYPE 创建===========");
    ...
    private void createBaseDataTable(String tenantName) {
        ...
        dataModelDTO.setName("MD_BMS_ASSET_TYPE");
    ...
    public static DataModelDO getCreateDataMode(String tenantName) {
        ...
        dataModelDO.setName("MD_BMS_ASSET_TYPE");
        dataModelDO.setTenantName(tenantName);
        dataModelDO.setTitle("资产类型");
        ...
        // 添加字段
        dataModelDO.addColumn("IS_FIXED").columnTitle("是否固定店铺").columnType(DataModelType.modelTypeToColumnType(8)).lengths(20).columnAttr(DataModelType.ColumnAttr.FIXED);
        dataModelDO.addColumn("IS_RENT_RATES").columnTitle("是否计算出租率").columnType(DataModelType.modelTypeToColumnType(8)).lengths(20).columnAttr(DataModelType.ColumnAttr.FIXED);
