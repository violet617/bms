 ...
 * @Description  基础数据类型--付款进度
 */
public class TB_MD_BMS_PAY_SCHEDULE {
    private static final String Base_Data_NAME = "MD_BMS_PAY_SCHEDULE";

    private static final String Base_Data_TITLE = "付款进度";
