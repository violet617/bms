...
/**
 * @author xuyaping
 * @Description : 基础数据 产权资产
 * @Date: 2023/12/18  16:12
 */
@Component
public class MD_BMS_CQZC implements StorageSyncTask {
    @Override
    public void execute() {
        System.out.println("MD_BMS_ASSET_ZONE 创建===========");
    ...
    private static final String TABLE_NAME = "MD_BMS_CQZC";

    private static final String TABLE_TITLE = "产权资产";

    private static final String GROUP_NAME = "public";

    public static void init(String tenantName){
        System.out.println("=====创建产权资产======");
        //定义表（创建表）定义基础表，设置隔离、共享、列表等系统字段
        createBaseDataDefine(tenantName);
        createBaseDataTable(tenantName); //创建表，新旧表合并
    }
