 ...
 */
@Component
public class MD_BMS_REGION_TYPE implements StorageSyncTask {
    @Override
    public void execute() {
        System.out.println("MD_BMS_REGION_TYPE 创建===========");
    ...
    private void createBaseDataTable(String tenantName) {
        ...
        dataModelDTO.setName("MD_BMS_REGION_TYPE");
    ...
    public static DataModelDO getCreateDataMode(String tenantName) {
        ...
        dataModelDO.setName("MD_BMS_REGION_TYPE");
        dataModelDO.setTenantName(tenantName);
        dataModelDO.setTitle("物业区域类型");
