 ...
 * @Description 基础数据类型--银行账户
 */
public class TB_MD_BMS_BANK_ACCOUNT {
    private static final String Base_Data_NAME = "MD_BMS_BANK_ACCOUNT";

    private static final String Base_Data_TITLE = "银行账户";
...
//        dataList.add(initBaseData(tenantName,"01","2023"));
//        dataList.add(initBaseData(tenantName,"02","2022"));
//        dataList.add(initBaseData(tenantName,"03","2021"));
//        dataList.add(initBaseData(tenantName,"04","2020"));
//        dataList.add(initBaseData(tenantName,"05","2019"));
//        dataList.add(initBaseData(tenantName,"06","2018"));
...
//        dataClient.batchAdd(baseDataBatchOptDTO);
    ...
    private static void initBaseDataColumn(){
        ...
        tableDefine.addNvarcharBaseDataField("BANK","银行","MD_BANK");
        tableDefine.addNvarcharBaseDataField("SUBJECT","科目","MD_BMS_ACCOUNT_SUBJECT");
        tableDefine.addNvarcharBaseDataField("CUSTOMER","所属客户单位","MD_BMS_CUSTOMER");
        tableDefine.addNvarcharField("SUB_BANK","支行",100,null);
        tableDefine.addNumericField2("CARD_RATE","刷卡费率",14,2,null);
        tableDefine.addNvarcharField("ACCOUNTNAME","户名",100,null);
