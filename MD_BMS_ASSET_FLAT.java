 ...
 */
@Component
public class MD_BMS_ASSET_FLAT implements StorageSyncTask {
    @Override
    public void execute() {
        System.out.println("MD_BMS_ASSET_FLAT 创建===========");
    ...
    private static void createBaseDataDefine(String tenantName) {
        ...
        baseDataDefineDTO.setName("MD_BMS_ASSET_FLAT"); //单元
    ...
    private void createBaseDataTable(String tenantName) {
        ...
        dataModelDTO.setName("MD_BMS_ASSET_FLAT");
    ...
    public static DataModelDO getCreateDataMode(String tenantName) {
        ...
        dataModelDO.setName("MD_BMS_ASSET_FLAT");
        dataModelDO.setTenantName(tenantName);
        dataModelDO.setTitle("单元");
