 ...
 */
@Component
public class MD_BMS_STXM implements StorageSyncTask {
    private static final String TABLE_NAME = "MD_BMS_STXM";

    private static final String TABLE_TITLE = "实体项目";

    private static final String GROUP_NAME = "public";

    @Override
    public void execute() {
        System.out.println("MD_BMS_STXM 创建===========");
