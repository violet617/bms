 ...
 * @Description 基础数据类型--自定义项目
 */
public class TB_MD_BMS_CUSTOM_PROJECT {
    private static final String Base_Data_NAME = "MD_BMS_CUSTOM_PROJECT";

    private static final String Base_Data_TITLE = "自定义项目";
