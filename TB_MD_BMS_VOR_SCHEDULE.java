 ...
 * @Description 基础数据类型--凭证生成进度
 */
public class TB_MD_BMS_VOR_SCHEDULE {
    private static final String Base_Data_NAME = "MD_BMS_VOR_SCHEDULE";

    private static final String Base_Data_TITLE = "凭证生成进度";
