 ...
 */
@Component
public class MD_BMS_ASSET_BUILDING implements StorageSyncTask {
    @Override
    public void execute() {
        System.out.println("MD_BMS_ASSET_BUILDING 创建===========");
    ...
    private static void createBaseDataDefine(String tenantName) {
        ...
        baseDataDefineDTO.setName("MD_BMS_ASSET_BUILDING"); //楼栋
    ...
    private void createBaseDataTable(String tenantName) {
        ...
        dataModelDTO.setName("MD_BMS_ASSET_BUILDING");
    ...
    public static DataModelDO getCreateDataMode(String tenantName) {
        ...
        dataModelDO.setName("MD_BMS_ASSET_BUILDING");
        dataModelDO.setTenantName(tenantName);
        dataModelDO.setTitle("楼栋");
