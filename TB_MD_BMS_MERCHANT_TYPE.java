 ...
 * @Description 基础数据类型--商户类型
 */
public class TB_MD_BMS_MERCHANT_TYPE {
    private static final String Base_Data_NAME = "MD_BMS_MERCHANT_TYPE";

    private static final String Base_Data_TITLE = "商户类型";
