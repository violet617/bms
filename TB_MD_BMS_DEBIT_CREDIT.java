 ...
 * @Description 基础数据类型--借贷方
 */
public class TB_MD_BMS_DEBIT_CREDIT {
    private static final String Base_Data_NAME = "MD_BMS_DEBIT_CREDIT";

    private static final String Base_Data_TITLE = "借方贷方";
...
//        dataClient.batchAdd(baseDataBatchOptDTO);
    ...
    private static void initBaseDataColumn(){
        ...
        tableDefine.addDateTimeField("MODIFYTIME","修改时间");
