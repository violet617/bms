 ...
 * @Description 基础数据类型--项目级别
 */
public class TB_MD_BMS_PROJECT_LEVEL {
    private static final String Base_Data_NAME = "MD_BMS_PROJECT_LEVEL";

    private static final String Base_Data_TITLE = "项目级别";
