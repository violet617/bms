 ...
 * @Description 基础数据类型--业态
 */
public class TB_MD_BMS_TOB {
    private static final String Base_Data_NAME = "MD_BMS_TOB";

    private static final String Base_Data_TITLE = "业态";
...
//        dataClient.batchAdd(baseDataBatchOptDTO);
    ...
    private static void initBaseDataColumn(){
        ...
        tableDefine.addNvarcharBaseDataField("TOB_LABEL","标签","MD_BMS_TOB_LABEL");
