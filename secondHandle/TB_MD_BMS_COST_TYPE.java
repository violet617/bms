 ...
 * @Description 基础数据类型--费用类型
 */
public class TB_MD_BMS_COST_TYPE {
    private static final String Base_Data_NAME = "MD_BMS_COST_TYPE";

    private static final String Base_Data_TITLE = "费用类型";
    ...
    public static void init(String tenantName) {
        ...
        baseDataDefineDTO.setLevelcode("2222");
        //设置基础数据名称
...
//        dataClient.batchAdd(baseDataBatchOptDTO);
    ...
    private static void initBaseDataColumn(){
        ...
        tableDefine.addBooleanField("IS_DEPOSIT","押金",null);
        tableDefine.addBooleanField("IS_ZSK","暂收款",null);

        tableDefine.addNvarcharBaseDataField("XJLLL","现金流量类","MD_BMS_XJLLL");
        tableDefine.addNvarcharBaseDataField("MAP_TYPE","费用类型映射方式","MD_BMS_COST_MAP_TYPE");
        tableDefine.addNvarcharBaseDataField("INVOICE_TYPE","发票项目","MD_BMS_EL_GOODS");
        tableDefine.addNvarcharBaseDataField("DEPARTMENT","部门","MD_DEPARTMENT");
        tableDefine.addNvarcharBaseDataField("BILLDEFINE","单据定义","MD_BMS_BILLDEFINE");
        tableDefine.addNvarcharBaseDataField("RECEIVEBILL_TYPE","收款类型","MD_BMS_REBILL_TYPE");
        tableDefine.addNvarcharBaseDataField("TENANT_TYPE","商户类型","MD_BMS_MERCHANT_TYPE");
        tableDefine.addNvarcharBaseDataField("SKPZ_TYPE","收款凭证方式","MD_BMS_SKPZ_TYPE");
