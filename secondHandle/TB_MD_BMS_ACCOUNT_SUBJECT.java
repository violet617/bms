...
import static com.jiuqi.va.domain.basedata.OrgMngType.SharedAndIsolated;

/**
 * @Author wangyunfan
 * @Date 2023/12/15 17:37
 * @Description 基础数据类型--会计科目
 */
public class TB_MD_BMS_ACCOUNT_SUBJECT {
    private static final String Base_Data_NAME = "MD_BMS_ACCOUNT_SUBJECT";

    private static final String Base_Data_TITLE = "会计科目";
    ...
    public static void init(String tenantName) {
         ...
         *   3 级次树
         */
        baseDataDefineDTO.setStructtype(3);
        baseDataDefineDTO.setLevelcode("433333");
        //设置基础数据名称
         ...
         */
        baseDataDefineDTO.setSharetype(SharedAndIsolated.getCode());
...
//        dataClient.batchAdd(baseDataBatchOptDTO);
    ...
    private static void initBaseDataColumn(){
        ...
        tableDefine.addNvarcharBaseDataField("ACCOUNT_AUXILIARY","辅助核算类型","MD_BMSACCOUNT_AUXILIARY");
        tableDefine.addNvarcharBaseDataField("ORIENTCONTROL","借贷方控制","MD_BMS_DEBIT_CREDIT");
        tableDefine.addNvarcharBaseDataField("DEBIT_CREDIT","借贷方","MD_BMS_DEBIT_CREDIT");
        tableDefine.addNvarcharBaseDataField("JYSFXM","经营收费项目","MD_BMS_FZHS_JYSFXM");
        tableDefine.addNvarcharBaseDataField("FZHS_CXFWFQT","促销服务费其他","MD_BMS_FZHS_CXFWFQT");
        tableDefine.addNvarcharField("LC_CODE","浪潮科目代码",100,null);
        tableDefine.addNvarcharField("FZHS_DSK","浪潮代收款内码",100,null);
        tableDefine.addNvarcharField("FZHS_XJLL","浪潮现金流量内码",100,null);
