...
/**
 * @author xuyaping
 * @Description : 基础数据 经营业态
 * @Date: 2023/12/18  15:10
 */
@Component
public class MD_BMS_ASSET_JYYT implements StorageSyncTask {
    private static final String TABLE_NAME = "MD_BMS_ASSET_JYYT";

    private static final String TABLE_TITLE = "经营业态";

    private static final String GROUP_NAME = "public";

    @Override
    public void execute() {
        System.out.println("MD_BMS_ASSET_JYYT 创建===========");
    ...
    private static void createBaseDataDefine(String tenantName) {
        ...
        baseDataDefineDTO.setStructtype(0); //列表
    ...
    public static DataModelDO getCreateDataMode(String tenantName) {
        ...
        // 添加字段
        dataModelDO.addColumn("HCODE").columnTitle("业务编号").columnType(DataModelType.ColumnType.NVARCHAR).lengths(20).columnAttr(DataModelType.ColumnAttr.EXTEND);
    ...
    public boolean needCompareVersion() {
        return StorageSyncTask.super.needCompareVersion();
    }

    @Override
    public String getVersion() {
        return StorageSyncTask.super.getVersion();
    }
}
