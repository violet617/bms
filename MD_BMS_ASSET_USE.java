 ...
 */
@Component
public class MD_BMS_ASSET_USE implements StorageSyncTask {
    @Override
    public void execute() {
        System.out.println("MD_BMS_ASSET_USE 创建===========");
    ...
    private void createBaseDataTable(String tenantName) {
        ...
        dataModelDTO.setName("MD_BMS_ASSET_USE");
    ...
    public static DataModelDO getCreateDataMode(String tenantName) {
        ...
        dataModelDO.setName("MD_BMS_ASSET_USE");
        dataModelDO.setTenantName(tenantName);
        dataModelDO.setTitle("资产用途");
