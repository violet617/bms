 ...
 */
@Component
public class MD_BMS_CUSTOMER_TYPE implements StorageSyncTask {
    private static final String TABLE_NAME = "MD_BMS_CUSTOMER_TYPE";

    private static final String TABLE_TITLE = "客商类型";

    private static final String GROUP_NAME = "public";
    @Override
    public void execute() {
        System.out.println("MD_BMS_CUSTOMER_TYPE init创建===========");
