 ...
 * @Description 基础数据类型--结算方式
 */
public class TB_MD_BMS_SETTLE_TYPE {
    private static final String Base_Data_NAME = "MD_BMS_SETTLE_TYPE";

    private static final String Base_Data_TITLE = "结算方式";
...
//        dataClient.batchAdd(baseDataBatchOptDTO);
    ...
    private static void initBaseDataColumn(){
        ...
        tableDefine.addNvarcharField("LC_CODE","浪潮代码",100,null);
        tableDefine.addBooleanField("CASHFLOW","是否有现金流项目",null);
        tableDefine.addNvarcharBaseDataField("DEBIT_ACCOUNT","借方科目","MD_BMS_ACCOUNT_SUBJECT");
        tableDefine.addNvarcharBaseDataField("CREDIT_ACCOUNT","贷方科目","MD_BMS_ACCOUNT_SUBJECT");
        tableDefine.addBooleanField("ISBANK","是否银行结算",null);
        tableDefine.addBooleanField("ISRATE","是否有刷卡费率",null);
        tableDefine.addBooleanField("ONSITE_PAY","现场支付",null);
        tableDefine.addNvarcharField("NEED_FIELDS","收款单弹窗字段",100,null);
        tableDefine.addNvarcharField("NEED_PAY_FIELDS","付款单弹窗字段",100,null);
        tableDefine.addNvarcharField("HCODE","业务编号",100,null);
        tableDefine.addBooleanField("F1","暂付单可用",null);
        tableDefine.addBooleanField("F2","合同结算可用",null);
