 ...
 * @Description 基本数据类型--收款项目
 */
public class TB_MD_BMS_FEE_TYPE {
    private static final String Base_Data_NAME = "MD_BMS_FEE_TYPE";

    private static final String Base_Data_TITLE = "收款项目";
    ...
    private static void initBaseDataColumn(){
        ...
        tableDefine.addNvarcharBaseDataField("SKXMFZ","收款项目分组","MD_BMS_SKXMFZ");
        tableDefine.addNvarcharBaseDataField("FIN_FEE_TYPE","关联财务费用类型","MD_BMS_COST_TYPE");
        tableDefine.addNvarcharBaseDataField("NATURE","收款项目性质","MD_BMS_FEE_TYPE_XZ");
        tableDefine.addBooleanField("ONE_TIME_FEE","一次性费用",null);
        tableDefine.addBooleanField("IS_DEPOSIT","押金",null);
        tableDefine.addBooleanField("IS_ROY","提成费用",null);
        tableDefine.addBooleanField("SITEFEE","现场费用",null);
