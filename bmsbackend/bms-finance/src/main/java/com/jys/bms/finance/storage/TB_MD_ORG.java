 ...
 * @Description 基础数据类型--组织
 */
public class TB_MD_ORG {
    private static final String Base_Data_NAME = "MD_BMS_XJLLL";

    private static final String Base_Data_TITLE = "现金流量类";
    ...
    public static void init(String tenantName) {
         ...
         *   3 级次树
         */
        baseDataDefineDTO.setStructtype(2);
        //设置基础数据名称
...
//        dataClient.batchAdd(baseDataBatchOptDTO);
    ...
    private static void initBaseDataColumn(){
        ...
        tableDefine.addNvarcharField("ENGNAME","英文名称",100,null);
        tableDefine.addNvarcharField("","",10,null);
        tableDefine.addNvarcharField("","",20,null);
        tableDefine.addNvarcharField("","",100,null);
        tableDefine.addNvarcharField("","",30,null);
        tableDefine.addNvarcharField("","",10,null);
        tableDefine.addNvarcharField("","",200,null);
        tableDefine.addNvarcharField("","",20,null);
