...
/**
 * @Author wangyunfan
 * @Date 2023/12/14 9:46
 * @Description 基础数据类型--收款方式
 */
//@Component
public class TB_MD_BMS_RENT_SET_TYPE {
    private static final String Base_Data_NAME = "MD_BMS_RENT_SET_TYPE";

    private static final String Base_Data_TITLE = "租金结算方式";
    ...
    public static void init(String tenantName) {
        ...
        dataList.add(initBaseData(tenantName,"02","微信"));
        dataList.add(initBaseData(tenantName,"03","支付宝"));
        dataList.add(initBaseData(tenantName,"04","刷卡"));
        dataList.add(initBaseData(tenantName,"05","汇款"));
    ...
    private static void initBaseDataColumn(){
        ...
        tableDefine.addNvarcharBaseDataField("FEE_TYPE","押金类型","MD_BMS_FEE_TYPE");
        tableDefine.addNvarcharBaseDataField("CUSTOMRE","关联单位","MD_BMS_CUSTOMER");
        tableDefine.addNvarcharBaseDataField("FIN_SETTLE_TYPE","财务结算方式","MD_BMS_SETTLE_TYPE");
        tableDefine.addNvarcharBaseDataField("COST_TYPE","关联费用类型","MD_BMS_COST_TYPE");
