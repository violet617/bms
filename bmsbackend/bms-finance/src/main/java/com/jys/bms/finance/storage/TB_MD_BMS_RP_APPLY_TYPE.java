 ...
 * @Description 基础数据类型--收付款申请单类型
 */
public class TB_MD_BMS_RP_APPLY_TYPE {
    private static final String Base_Data_NAME = "MD_BMS_RP_APPLY_TYPE";

    private static final String Base_Data_TITLE = "收付款申请单类型";
...
//        dataClient.batchAdd(baseDataBatchOptDTO);
    ...
    private static void initBaseDataColumn(){
        ...
        tableDefine.addNvarcharField("RELATION_BILLDEFINE","关联单据标识",100,null);
        tableDefine.addBooleanField("UNPAID_INVOICE","已确认税未收回发票",null);
        tableDefine.addBooleanField("YF_TRANSFER","应付中转",null);
