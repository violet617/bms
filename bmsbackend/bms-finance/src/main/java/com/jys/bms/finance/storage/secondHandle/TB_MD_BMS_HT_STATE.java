 ...
 * @Description 基础数据类型--合同状态
 */
public class TB_MD_BMS_HT_STATE {
    private static final String Base_Data_NAME = "MD_BMS_HT_STATE";

    private static final String Base_Data_TITLE = "合同状态";
...
//        dataClient.batchAdd(baseDataBatchOptDTO);
    ...
    private static void initBaseDataColumn(){
        ...
        tableDefine.addNvarcharField("MEMO","备注",200,null);
