 ...
 * @Description 基础数据类型--税率
 */
public class TB_MD_BMS_RATE_VALUE {

    private static final String Base_Data_NAME = "MD_BMS_RATE_VALUE";

    private static final String Base_Data_TITLE = "税率";
    ...
    public static void init(String tenantName) {
        ...
        dataList.add(initBaseData(tenantName,"02","税率测试字段"));
    ...
    private static void initBaseDataColumn(){
        ...
        tableDefine.addNumericField2("RATE_VALUE","税率值",14,2,null);
        tableDefine.addNvarcharBaseDataField("PAY_SUBJECT","进项对应科目","MD_BMS_ACCOUNT_SUBJECT");
        tableDefine.addNvarcharBaseDataField("RECEIVE_SUBJECT","销项对应科目","MD_BMS_ACCOUNT_SUBJECT");
        tableDefine.addNvarcharBaseDataField("LS_RECEIVE_SUBJECT","零售销项对应科目","MD_BMS_ACCOUNT_SUBJECT");
