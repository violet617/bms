 ...
 * @Description 基础数据类型--付款单据类型
 */
public class TB_MD_BMS_PAYBILL_TYPE {
    private static final String Base_Data_NAME = "MD_BMS_PAYBILL_TYPE";

    private static final String Base_Data_TITLE = "付款单据类型";
