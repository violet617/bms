 ...
 * @Description 基础数据类型--收款项目分组
 */
public class TB_MD_BMS_SKXMFZ {
    private static final String Base_Data_NAME = "MD_BMS_SKXMFZ";

    private static final String Base_Data_TITLE = "收款项目分组";
...
//        dataList.add(initBaseData(tenantName,"01","收款项目分组01"));
//        dataList.add(initBaseData(tenantName,"02","收款项目分组02"));
//        dataList.add(initBaseData(tenantName,"03","收款项目分组03"));
...
//        dataClient.batchAdd(baseDataBatchOptDTO);
    ...
    private static void initBaseDataColumn(){
        ...
        tableDefine.addBooleanField("SELECTED","已选择",null);
        tableDefine.addIntegerField("SHARETYPE","共享类型",null);
