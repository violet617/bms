 ...
 * @Description 基础数据类型--合同性质
 */
public class TB_MD_BMS_HT_NATURE {
    private static final String Base_Data_NAME = "MD_BMS_HT_NATURE";

    private static final String Base_Data_TITLE = "合同性质";
