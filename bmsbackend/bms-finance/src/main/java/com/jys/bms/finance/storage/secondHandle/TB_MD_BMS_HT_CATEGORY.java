 ...
 * @Description 基础数据类型--合同类别
 */
public class TB_MD_BMS_HT_CATEGORY {
    private static final String Base_Data_NAME = "MD_BMS_HT_CATEGORY";

    private static final String Base_Data_TITLE = "合同类别";
...
//        dataClient.batchAdd(baseDataBatchOptDTO);
    ...
    private static void initBaseDataColumn(){
        ...
        tableDefine.addIntegerField("SHARETYPE","合同类别",null);
