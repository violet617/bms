 ...
 * @Description 基础数据类型--品牌
 */
public class TB_MD_BMS_BRAND {
    private static final String Base_Data_NAME = "MD_BMS_BRAND";

    private static final String Base_Data_TITLE = "品牌";
...
//        dataClient.batchAdd(baseDataBatchOptDTO);
    ...
    private static void initBaseDataColumn(){
        ...
        tableDefine.addNvarcharBaseDataField("TOB","所属业态","MD_BMS_TOB");
        tableDefine.addDateField("CREATETIME","创建时间");
        tableDefine.addDateField("MODIFYTIME","修改时间");
        tableDefine.addDateField("CREATETIME","创建时间");
        tableDefine.addNvarcharField("MODIFYUSER","修改人",100,null);
        tableDefine.addNvarcharField("CN_NAME","中午名称",100,null);
        tableDefine.addNvarcharField("EN_NAME","英文名称",100,null);
        tableDefine.addNvarcharField("CY_NAME","品类名称",100,null);
        tableDefine.addNvarcharField("BRAND_NAME","品牌名称",100,null);
