 ...
 * @Description 基本数据类型--项目
 */
public class TB_MD_BMS_HT_PROJECT {
    private static final String Base_Data_NAME = "MD_BMS_HT_PROJECT";

    private static final String Base_Data_TITLE = "项目";
    ...
    public static void init(String tenantName) {
        ...
        baseDataDefineDTO.setGroupfieldname("PROJECT_TYPE");
        //设置基础数据名称
...
//        dataClient.batchAdd(baseDataBatchOptDTO);
    ...
    private static void initBaseDataColumn(){
        ...
        tableDefine.addBooleanField("BASEDATAMARKER","基础数据标记",null);
        tableDefine.addBooleanField("IF_CONTAIN_CHILDPRO","是否含有子项目",null);
        tableDefine.addBooleanField("IF_IN_YEARPLAN","是否年度计划内",null);
        tableDefine.addDateField("SPONSOR_TIME","项目发起时间");
        tableDefine.addDateField("SDATE","执行开始日期");
        tableDefine.addDateField("EDATE","执行结束日期");
        tableDefine.addNvarcharField("PROJECT_ADDRESS","项目地点",100,null);
        tableDefine.addNvarcharField("PROJECT_THEME","项目主题",100,null);
        tableDefine.addNvarcharField("PROJECT_TARGENT","项目目标",100,null);
        tableDefine.addNvarcharField("FIRST_PARTY","甲方",100,null);
        tableDefine.addNvarcharField("SECOND_PARTY","乙方",100,null);
        tableDefine.addNvarcharField("THIRD_PARTY","丙方",100,null);
        tableDefine.addTextField("PROJECT_CONTENT","项目内容");

        tableDefine.addNvarcharBaseDataField("PROJECT_SPONSOR","项目发起人","MD_STAFF");
        tableDefine.addNvarcharBaseDataField("SPONSOR_DEPT","发起部门","MD_DEPARTMENT");
        tableDefine.addNvarcharBaseDataField("PROJECT_LEADER","项目负责人","MD_STAFF");
        tableDefine.addNvarcharBaseDataField("COST_CENTER","成本中心","MD_BMS_COST_CENTER");
        tableDefine.addNvarcharBaseDataField("PROJECT_TYPE","项目类型","MD_BMS_PROJECT_TYPE");
        tableDefine.addNvarcharBaseDataField("PROJECT_LEVEL","项目级别","MD_BMS_PROJECT_LEVEL");
        tableDefine.addNvarcharBaseDataField("JOIN_DEPTS","相关部门","MD_DEPARTMENT");
