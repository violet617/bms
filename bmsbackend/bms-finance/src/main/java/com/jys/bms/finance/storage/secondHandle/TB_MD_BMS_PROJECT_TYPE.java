 ...
 * @Description 基础数据类型--项目类型
 */
public class TB_MD_BMS_PROJECT_TYPE {
    private static final String Base_Data_NAME = "MD_BMS_PROJECT_TYPE";

    private static final String Base_Data_TITLE = "项目类型";
