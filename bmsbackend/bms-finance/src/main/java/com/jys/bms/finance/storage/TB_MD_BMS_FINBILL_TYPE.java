 ...
 * @Description 基础数据类型--财务票据类型
 */
public class TB_MD_BMS_FINBILL_TYPE {

    private static final String Base_Data_NAME = "MD_BMS_FINBILL_TYPE";

    private static final String Base_Data_TITLE = "财务票据类型";
