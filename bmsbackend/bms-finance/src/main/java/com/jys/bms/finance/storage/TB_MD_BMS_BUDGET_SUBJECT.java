 ...
 * @Description 基本数据类型--预算科目
 */
public class TB_MD_BMS_BUDGET_SUBJECT {
    private static final String Base_Data_NAME = "MD_BMS_BUDGET_SUBJECT";

    private static final String Base_Data_TITLE = "预算科目";
