 ...
 * @Description 基础数据类型--收款项目性质
 */
public class TB_MD_BMS_FEE_TYPE_XZ {
    private static final String Base_Data_NAME = "MD_BMS_FEE_TYPE_XZ";

    private static final String Base_Data_TITLE = "收款项目性质";
