 ...
 * @Description 基本数据类型--收款单据类型
 */
public class TB_MD_BMS_REBILL_TYPE {
    private static final String Base_Data_NAME = "MD_BMS_REBILL_TYPE";

    private static final String Base_Data_TITLE = "收款单据类型";
