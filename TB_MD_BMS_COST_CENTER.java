 ...
 * @Description 基本数据类型--成本中心
 */
public class TB_MD_BMS_COST_CENTER {
    private static final String Base_Data_NAME = "MD_BMS_COST_CENTER";

    private static final String Base_Data_TITLE = "成本中心";
    ...
    public static void init(String tenantName) {
        ...
        baseDataDefineDTO.setLevelcode("233");
        //设置基础数据名称
...
//        dataClient.batchAdd(baseDataBatchOptDTO);
    ...
    private static void initBaseDataColumn(){
        ...
        tableDefine.addNvarcharBaseDataField("COST_CENT_TYPE","成本中心类型","MD_BMS_COST_CENT_TYPE");
        tableDefine.addNvarcharField("YS_FIELD","预算对应字段标识",100,null);
